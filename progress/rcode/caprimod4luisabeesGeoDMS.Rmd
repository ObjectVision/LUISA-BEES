...
fldr_GAMS  <- "C:\\GAMS\\37"
fldr_datapath <- "C:\\Users\\Cicada\\prj\\capri_r\\data"                      # input
fldr_nominmax <- "C:\\Users\\Cicada\\prj\\capri_r\\nominmax"                  # output nominmax
fldr_minmax <- "C:\\Users\\Cicada\\prj\\capri_r\\enddata_july2019"            # output minmax
fldr_eqminmax <- "C:\\Users\\Cicada\\prj\\capri_r\\eqminmax"
...
interpolated %>% 
  ...
  walk2(
    .x = .$countryiso2,
    .y = .$data,
   .f = ~ write_csv(.y, file.path(fldr_minmax, str_c(.x, ".csv")))
  )
